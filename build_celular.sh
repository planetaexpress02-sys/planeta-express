...
printf '%s' "$(duri assets/fotos/m8.png image/png)" > "$TMP/uri_m8"
...
perl -pe '
  BEGIN{
    ...
    $m4=rd($ENV{T}."/uri_m4"); $m5=rd($ENV{T}."/uri_m5"); $m8=rd($ENV{T}."/uri_m8");
  }
  s{__LOGO__}{$icon}g;
...
perl -pe '
  ...
  s{assets/fotos/m4\.png}{}g; s{assets/fotos/m5\.jpg}{}g; s{assets/fotos/m8.png}{}g;
