...
cat assets/viagens.js assets/dados.js assets/alarmes.js assets/arquivos.js assets/importar.js assets/app.js assets/central.js assets/monitoramento.js assets/contabilidade.js assets/aniversarios.js assets/assistente.js > "$TMP/all.js"
