...
const MANUT_SEED = [
  {id:'mi_v1_01',data:'2021-04-13',veiculoId:'v1',descricao:'Trocado Bronzinas',oficina:'Volvo',km:1333000,valor:0,obs:''},
  {id:'mi_v1_02',data:'2022-11-11',veiculoId:'v1',descricao:'Trocado Correias Alternador',oficina:'Truta',km:1387000,valor:550,obs:''},
  {id:'mi_v1_03',data:'2023-01-17',veiculoId:'v1',descricao:'Trocado módulo ignição',oficina:'Volmix',km:1395000,valor:10000,obs:''},
  {id:'mi_v1_04',data:'2023-07-18',veiculoId:'v1',descricao:'Trocado Embreagem recon',oficina:'Truta',km:1445000,valor:3500,obs:''},
  {id:'mi_v1_05',data:'2024-02-09',veiculoId:'v1',descricao:'Trocado Valvula PU',oficina:'Katatal Marialva',km:1460000,valor:1000,obs:''},
  {id:'mi_v1_06',data:'2024-02-20',veiculoId:'v1',descricao:'Trocado Bomba Hidráulica',oficina:'Jorginho PG',km:1460000,valor:4000,obs:''},
  {id:'mi_v1_07',data:'2024-05-10',veiculoId:'v1',descricao:'Barra Direção',oficina:'Junior atras cunhado',km:1472000,valor:900,obs:''},
  {id:'mi_v1_08',data:'2025-04-16',veiculoId:'v1',descricao:'Trocado reservatório de água/mangueiras e aditivo',oficina:'RR radiadores',km:1489000,valor:1250,obs:''},
  {id:'mi_v1_09',data:'2026-01-15',veiculoId:'v1',descricao:'Revisado molejos',oficina:'Arnaldo AM',km:1495000,valor:2500,obs:''},
  {id:'mi_v1_10',data:'2026-01-15',veiculoId:'v1',descricao:'Trocado 5 Roda Recondicionada',oficina:'Arnaldo AM',km:1495000,valor:2500,obs:''},
  {id:'mi_v1_11',data:'2026-01-15',veiculoId:'v1',descricao:'Teclado Rastreador novo',oficina:'Truck Control PG',km:1495000,valor:1268,obs:''},
  {id:'mi_v1_12',data:'2026-01-19',veiculoId:'v1',descricao:'Pistão hidraulico',oficina:'Jango',km:1495000,valor:750,obs:''},
  {id:'mi_v1_13',data:'2026-01-23',veiculoId:'v1',descricao:'Placas Solares',oficina:'Cunhado',km:1495000,valor:2000,obs:''},
  {id:'mi_v1_14',data:'2026-07-15',veiculoId:'v1',descricao:'Embreagem nova completa Sachs 430MM',oficina:'Trizotto',km:1503500,valor:7791,obs:''},
  {id:'mi_v1_15',data:'2026-07-15',veiculoId:'v1',descricao:'Atuador de embreagem novo Sachs',oficina:'Trizotto',km:1503500,valor:4750,obs:''},
  {id:'mi_v1_16',data:'2026-07-15',veiculoId:'v1',descricao:'Valvula PWM câmbio nova masterfex',oficina:'Trizotto',km:1503500,valor:1418,obs:''},
  {id:'mi_v1_17',data:'2026-07-20',veiculoId:'v1',descricao:'Revisado Valvula distribuidora Wabco',oficina:'JJS Freios',km:1503500,valor:415.65,obs:''},
  {id:'mi_v1_18',data:'2026-07-20',veiculoId:'v1',descricao:'Flexivel caixa atuador PWM',oficina:'Trizotto',km:1503500,valor:432,obs:''},
  {id:'mi_v1_19',data:'2026-07-20',veiculoId:'v1',descricao:'Sensor ABS truck LE',oficina:'Trizotto',km:1503500,valor:415,obs:''},
  {id:'mi_v5_01',data:'2025-08-01',veiculoId:'v5',descricao:'Embreagem nova original ( Del pozo)',oficina:'Volvo',km:499000,valor:0,obs:''},
  {id:'mi_v5_02',data:'2026-03-15',veiculoId:'v5',descricao:'Revisão Volvo ( Del pozo )',oficina:'Volvo',km:543000,valor:0,obs:''},
  {id:'mi_v5_03',data:'2026-04-21',veiculoId:'v5',descricao:'Substituido Roda fônica tração',oficina:'Volvo',km:545000,valor:3000,obs:''},
  {id:'mi_v5_04',data:'2026-04-21',veiculoId:'v5',descricao:'Subtituido fluido arrefecimento',oficina:'Volvo',km:545000,valor:2700,obs:''},
  {id:'mi_v5_05',data:'2026-04-21',veiculoId:'v5',descricao:'Pintura Cabine',oficina:'Volvo',km:545000,valor:0,obs:''},
  {id:'mi_v5_06',data:'2026-06-02',veiculoId:'v5',descricao:'Subtituido 2 Bolsas de ar tração',oficina:'Alinha laser',km:547000,valor:2200,obs:''},
  {id:'mi_v5_07',data:'2026-06-20',veiculoId:'v5',descricao:'Substituido bolsa de ar truck LE',oficina:'Alinha laser',km:548000,valor:1100,obs:''},
  {id:'mi_v4_01',data:'2024-05-10',veiculoId:'v4',descricao:'Trocado junta carter e retentor virabrequim',oficina:'Truta',km:627000,valor:1300,obs:''},
  {id:'mi_v4_02',data:'2024-05-10',veiculoId:'v4',descricao:'Revisado Freios cavalo',oficina:'Truta',km:627000,valor:600,obs:''},
  {id:'mi_v4_03',data:'2024-05-10',veiculoId:'v4',descricao:'Scanner para resolver falhas',oficina:'Truta',km:627000,valor:250,obs:''},
  {id:'mi_v4_04',data:'2024-06-13',veiculoId:'v4',descricao:'Valvula Termostatica, mangueira agua + M.o',oficina:'Passarim',km:629000,valor:2025,obs:''},
  {id:'mi_v4_05',data:'2024-07-15',veiculoId:'v4',descricao:'Bolsa Cabine Ld e Le',oficina:'Truta( pereck)',km:633000,valor:1000,obs:''},
  {id:'mi_v4_06',data:'2024-10-03',veiculoId:'v4',descricao:'bolsa Cabine LE',oficina:'Passarim',km:636000,valor:500,obs:''},
  {id:'mi_v4_07',data:'2024-10-10',veiculoId:'v4',descricao:'Modulo Arla',oficina:'Ivesul Ricardo',km:638000,valor:2500,obs:''},
  {id:'mi_v4_08',data:'2024-10-10',veiculoId:'v4',descricao:'Reparo Valvula PU + Filtro',oficina:'Ivesul Ricardo',km:638000,valor:500,obs:''},
  {id:'mi_v4_09',data:'2024-10-10',veiculoId:'v4',descricao:'Revisado Sistema freio motor',oficina:'Ivesul Ricardo',km:638000,valor:1600,obs:''},
  {id:'mi_v4_10',data:'2024-10-10',veiculoId:'v4',descricao:'Limpeza Catalisador',oficina:'Ivesul Ricardo',km:638000,valor:2000,obs:''},
  {id:'mi_v4_11',data:'2025-03-06',veiculoId:'v4',descricao:'Revisado Cubo completo tração LD',oficina:'4 irmaos',km:'',valor:4300,obs:''},
  {id:'mi_v4_12',data:'2026-03-23',veiculoId:'v4',descricao:'2 Pneus novos diateira Goodyear',oficina:'Planeta',km:670000,valor:0,obs:''},
  {id:'mi_v3_01',data:'2022-09-22',veiculoId:'v3',descricao:'Motor de partida revisado',oficina:'',km:1050000,valor:1000,obs:''},
  {id:'mi_v3_02',data:'2023-01-25',veiculoId:'v3',descricao:'6 Unidades Inetoras revisadas bosch',oficina:'Vilmar Diesel',km:1065000,valor:7800,obs:''},
  {id:'mi_v3_03',data:'2023-01-25',veiculoId:'v3',descricao:'Limpeza Tanques',oficina:'Truta',km:1065000,valor:400,obs:''},
  {id:'mi_v3_04',data:'2023-01-25',veiculoId:'v3',descricao:'Turbina Holset reman',oficina:'Contorno turbo',km:1065000,valor:680,obs:''},
  {id:'mi_v3_05',data:'2023-11-08',veiculoId:'v3',descricao:'Embreagem Sachs recond',oficina:'Cambé',km:1076000,valor:3620,obs:''},
  {id:'mi_v3_06',data:'2023-11-18',veiculoId:'v3',descricao:'Cilindro e servo novos',oficina:'Alan cocamar',km:1076000,valor:2400,obs:''},
  {id:'mi_v3_07',data:'2024-01-25',veiculoId:'v3',descricao:'Revisado Cambio',oficina:'Truta',km:1080000,valor:11200,obs:''},
  {id:'mi_v3_08',data:'2024-02-24',veiculoId:'v3',descricao:'Revisado Servo embreagem',oficina:'Lucas Cambé',km:1083000,valor:750,obs:''},
  {id:'mi_v3_09',data:'2024-03-26',veiculoId:'v3',descricao:'Motor novo , exceto cilindros (usados)',oficina:'Truta',km:1083000,valor:32000,obs:''},
  {id:'mi_v3_10',data:'2024-03-26',veiculoId:'v3',descricao:'Embreagem Sachs recond',oficina:'Truta',km:1083000,valor:3900,obs:''},
  {id:'mi_v3_11',data:'2024-03-26',veiculoId:'v3',descricao:'Cremalheira usada',oficina:'Truta',km:1083000,valor:1000,obs:''},
  {id:'mi_v3_12',data:'2024-03-26',veiculoId:'v3',descricao:'Revisado Radiador e Intercooler',oficina:'Fabio Radiadores PG',km:1083000,valor:1100,obs:''},
  {id:'mi_v3_13',data:'2024-04-20',veiculoId:'v3',descricao:'Servo embreagem importado',oficina:'Truta',km:1084000,valor:1280,obs:''},
  {id:'mi_v3_14',data:'2024-06-21',veiculoId:'v3',descricao:'Trocado cilindro e flexivel embreagem',oficina:'Truta',km:1089000,valor:850,obs:''},
  {id:'mi_v3_15',data:'2025-09-18',veiculoId:'v3',descricao:'Teste intercooler',oficina:'Truta',km:1104000,valor:200,obs:''},
  {id:'mi_v3_16',data:'2025-09-18',veiculoId:'v3',descricao:'Trocado mola tração',oficina:'Arnaldo molas',km:1104000,valor:300,obs:''},
  {id:'mi_v3_17',data:'2025-09-18',veiculoId:'v3',descricao:'revisado freios dianteiros',oficina:'Arnaldo molas',km:1104000,valor:500,obs:''},
  {id:'mi_v7_01',data:'2022-08-24',veiculoId:'v7',descricao:'Bomba d\'agua',oficina:'Piloto Londrina',km:'',valor:1600,obs:'Hora TK: 24290 h'},
  {id:'mi_v7_02',data:'2022-10-24',veiculoId:'v7',descricao:'Motor de Partida novo',oficina:'TK Piloto Cascavel',km:'',valor:1750,obs:'Hora TK: 25100 h'},
  {id:'mi_v7_03',data:'2023-10-10',veiculoId:'v7',descricao:'Solenoide partida',oficina:'Mazinho',km:'',valor:400,obs:''},
  {id:'mi_v7_04',data:'2024-01-29',veiculoId:'v7',descricao:'Trocado Placa eletronica reman',oficina:'Mazinho',km:'',valor:1870,obs:''},
  {id:'mi_v7_05',data:'2024-01-29',veiculoId:'v7',descricao:'Trocado Controlador reman',oficina:'Mazinho',km:'',valor:2400,obs:''},
  {id:'mi_v7_06',data:'2024-10-23',veiculoId:'v7',descricao:'Trocado automatico MP e polia alternador',oficina:'Mazinho',km:'',valor:1400,obs:'Hora TK: 1400 h'},
  {id:'mi_v7_07',data:'2025-03-07',veiculoId:'v7',descricao:'Trocado correia dentada',oficina:'New ar Foz',km:'',valor:430,obs:''},
  {id:'mi_v7_08',data:'2025-10-29',veiculoId:'v7',descricao:'Bomba d\'agua',oficina:'Mazinho',km:'',valor:1080,obs:''},
  {id:'mi_v7_09',data:'2025-10-29',veiculoId:'v7',descricao:'Bomba Injetora',oficina:'Mazinho',km:'',valor:5500,obs:''},
  {id:'mi_v8_01',data:'2024-09-24',veiculoId:'v8',descricao:'Trocado kit correias',oficina:'Piloto LDN',km:'',valor:500,obs:'Hora TK: 1600 h'},
  {id:'mi_v8_02',data:'2024-05-20',veiculoId:'v8',descricao:'Compressor novo',oficina:'Mazinho',km:'',valor:27000,obs:''},
  {id:'mi_v8_03',data:'2025-08-19',veiculoId:'v8',descricao:'Motor TIER - 1',oficina:'Mazinho',km:'',valor:18000,obs:'Hora TK: 7500 h'},
  {id:'mi_v8_04',data:'2025-08-19',veiculoId:'v8',descricao:'Rolamento mancal helice / retentor polia',oficina:'Mazinho',km:'',valor:500,obs:'Hora TK: 7500 h'},
  {id:'mi_v8_05',data:'2025-12-10',veiculoId:'v8',descricao:'Trocado Controlador e placa',oficina:'Mazinho',km:'',valor:0,obs:''},
  {id:'mi_v8_06',data:'2026-07-15',veiculoId:'v8',descricao:'Sensor oleo',oficina:'Mazinho',km:'',valor:475,obs:''},
  {id:'mi_v9_01',data:'2022-08-25',veiculoId:'v9',descricao:'Revisado motor de partida',oficina:'Mazinho',km:'',valor:850,obs:''},
  {id:'mi_v9_02',data:'2022-09-13',veiculoId:'v9',descricao:'Alternador novo',oficina:'Piloto TK',km:'',valor:2100,obs:'Hora TK: 28300 h'},
  {id:'mi_v9_03',data:'2023-06-06',veiculoId:'v9',descricao:'Rolamento e eixo mancal intermediario transmissão',oficina:'Mazinho',km:'',valor:1280,obs:''},
  {id:'mi_v9_04',data:'2023-06-06',veiculoId:'v9',descricao:'Correia Alternador',oficina:'Mazinho',km:'',valor:153,obs:''},
  {id:'mi_v9_05',data:'2023-07-25',veiculoId:'v9',descricao:'Kit Coxim',oficina:'Mazinho',km:'',valor:630,obs:''},
  {id:'mi_v9_06',data:'2023-10-25',veiculoId:'v9',descricao:'Kit Correias',oficina:'Piloto TK',km:'',valor:310,obs:''},
  {id:'mi_v9_07',data:'2024-05-25',veiculoId:'v9',descricao:'Trocado Controlador',oficina:'Mazinho',km:'',valor:2400,obs:''},
  {id:'mi_v9_08',data:'2024-05-20',veiculoId:'v9',descricao:'Revisado motor de partida basico',oficina:'Mazinho',km:'',valor:650,obs:''},
  {id:'mi_v9_09',data:'2024-06-20',veiculoId:'v9',descricao:'Trocado kit correias',oficina:'Mazinho',km:'',valor:488,obs:''},
  {id:'mi_v9_10',data:'2024-06-20',veiculoId:'v9',descricao:'Esticador Alternador',oficina:'Mazinho',km:'',valor:126,obs:''},
  {id:'mi_v9_11',data:'2025-03-05',veiculoId:'v9',descricao:'Trocado sensores frio',oficina:'Mazinho',km:'',valor:1000,obs:''},
  {id:'mi_v9_12',data:'2026-01-20',veiculoId:'v9',descricao:'Motor novo Reman',oficina:'Mazinho',km:'',valor:16000,obs:''},
  {id:'mi_v9_13',data:'2026-01-20',veiculoId:'v9',descricao:'Sistema arrefecimento reman',oficina:'Mazinho',km:'',valor:8000,obs:''},
  {id:'mi_v10_01',data:'2024-05-25',veiculoId:'v10',descricao:'Bomba injetora',oficina:'Mazinho',km:'',valor:8000,obs:'Hora TK: 10100 h'},
  {id:'mi_v10_02',data:'2024-10-23',veiculoId:'v10',descricao:'Trocado correias',oficina:'Mazinho',km:'',valor:0,obs:'Hora TK: 12750 h'},
  {id:'mi_v10_03',data:'2026-05-25',veiculoId:'v10',descricao:'Bomba Injetora Reman Tier ll',oficina:'Mazinho',km:'',valor:7500,obs:''},
  {id:'mi_v10_04',data:'2026-05-25',veiculoId:'v10',descricao:'Kit Correia',oficina:'Mazinho',km:'',valor:492,obs:''},
  {id:'mi_v10_05',data:'2026-05-25',veiculoId:'v10',descricao:'Kit Coxim',oficina:'Mazinho',km:'',valor:638,obs:''},
  {id:'mi_v10_06',data:'2026-05-25',veiculoId:'v10',descricao:'Solenoide de partida',oficina:'Mazinho',km:'',valor:398,obs:''},
  {id:'mi_v10_07',data:'2026-05-25',veiculoId:'v10',descricao:'Valvula check',oficina:'Mazinho',km:'',valor:200,obs:''},
  {id:'mi_v11_01',data:'2024-04-20',veiculoId:'v11',descricao:'Limpeza Tanque combustível',oficina:'Truta',km:'',valor:500,obs:'Hora TK: 7500 h'},
  {id:'mi_v11_02',data:'2024-10-25',veiculoId:'v11',descricao:'Motor novo TK ( Garantia )',oficina:'Videfrigo',km:'',valor:0,obs:'Hora TK: 8500 h'},
  {id:'mi_v11_03',data:'2024-10-25',veiculoId:'v11',descricao:'Compressor revisado full',oficina:'Videfrigo',km:'',valor:0,obs:'Hora TK: 8500 h'},
  {id:'mi_v11_04',data:'2024-10-25',veiculoId:'v11',descricao:'Trocado liquido arrefecimento',oficina:'Videfrigo',km:'',valor:0,obs:'Hora TK: 8500 h'},
  {id:'mi_v11_05',data:'2026-04-29',veiculoId:'v11',descricao:'Kit Valvula 3 vias',oficina:'Mazinho',km:'',valor:1327,obs:'Hora TK: 9500 h'},
  {id:'mi_v11_06',data:'2026-04-29',veiculoId:'v11',descricao:'Solenoite de aceleração',oficina:'Mazinho',km:'',valor:2911,obs:'Hora TK: 9500 h'},
  {id:'mi_v11_07',data:'2026-04-29',veiculoId:'v11',descricao:'Valvula de expansão',oficina:'Mazinho',km:'',valor:2217,obs:'Hora TK: 9500 h'},
  {id:'mi_v2_01',data:'2023-01-25',veiculoId:'v2',descricao:'Chicote motor',oficina:'Tigre',km:930000,valor:1000,obs:''},
  {id:'mi_v2_02',data:'2023-11-24',veiculoId:'v2',descricao:'Motor completo — bloco, virabrequim STD, bombas (água/óleo/diesel manual), comando de válvulas, kit pistões, bronzinas, radiador de óleo, roletes, juntas, servo e disco de embreagem novo, kit filtros, troca de óleo, limpeza de tanques, cabeçote revisado, torno volante do motor, pescador novo, unidades injetoras revisadas, turbina Holset HX50, mão de obra',oficina:'Truta',km:930000,valor:75000,obs:'Reforma geral do motor'},
  {id:'mi_v2_03',data:'2023-12-18',veiculoId:'v2',descricao:'Motor de partida (porta escova/automático/induzido)',oficina:'Lagoa Cambé',km:931000,valor:750,obs:''},
  {id:'mi_v2_04',data:'2024-01-25',veiculoId:'v2',descricao:'Limpeza Tanques',oficina:'Truta',km:933000,valor:500,obs:''},
  {id:'mi_v2_05',data:'2024-01-25',veiculoId:'v2',descricao:'Revisado Chicote',oficina:'Tigre',km:933000,valor:850,obs:''},
  {id:'mi_v2_06',data:'2024-01-25',veiculoId:'v2',descricao:'Limpeza radiador e intercooler',oficina:'Fabio Radiadores PG',km:933000,valor:1000,obs:''},
  {id:'mi_v2_07',data:'2024-03-05',veiculoId:'v2',descricao:'Trocado reservatório de água',oficina:'Truta',km:936000,valor:900,obs:''},
  {id:'mi_v2_08',data:'2024-10-10',veiculoId:'v2',descricao:'Boia Tanque Combustível',oficina:'Ivesul Ricardo',km:954000,valor:480,obs:''},
  {id:'mi_v2_09',data:'2024-10-10',veiculoId:'v2',descricao:'Amortecedor traseiro cabine com bolsa',oficina:'Ivesul Ricardo',km:954000,valor:748,obs:''},
  {id:'mi_v2_10',data:'2024-10-10',veiculoId:'v2',descricao:'Limpeza de Tanques com vapor',oficina:'Ivesul Ricardo',km:954000,valor:600,obs:''},
  {id:'mi_v2_11',data:'2024-10-10',veiculoId:'v2',descricao:'Scanner para falhas',oficina:'Ivesul Ricardo',km:954000,valor:150,obs:''},
  {id:'mi_v2_12',data:'2024-12-06',veiculoId:'v2',descricao:'Compressor motor novo',oficina:'Turim Diesel',km:956000,valor:4900,obs:''},
  {id:'mi_v2_13',data:'2024-12-09',veiculoId:'v2',descricao:'Conserto e reparo Válvula Transferência e 2 pinos',oficina:'Lucas Cambé',km:956000,valor:950,obs:''},
  {id:'mi_v2_14',data:'2026-06-18',veiculoId:'v2',descricao:'Revisado motor de partida',oficina:'Fujii Paiçandu',km:'',valor:1460,obs:''},
];
